...
<body>
    ...
    <div class="mainscreen">
        <iframe class="frames frame1 active" src="./modules/dashboard/index.php" frameborder="0"></iframe>
        <iframe class="frames frame2" src="./modules/booking/index.php" frameborder="0"></iframe>
        <iframe class="frames frame3" src="./modules/payment/index.php" frameborder="0"></iframe>
        <iframe class="frames frame4" src="./modules/room/index.php" frameborder="0"></iframe>
        <iframe class="frames frame5" src="./modules/staff/index.php" frameborder="0"></iframe>
    </div>
</body>
