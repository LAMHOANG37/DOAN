...
if (isset($_POST['Emp_login_submit'])) {
    ...
    if ($result->num_rows > 0) {
        ...
        $emp_login_error = "Invalid credentials";
    }
}
...
<body>
    ...
    <section id="auth_section">
        <div class="logo">
            <a href="index.php" style="text-decoration: none; color: inherit; display: flex; flex-direction: column; align-items: center;">
        ...
        <div class="auth_container">
            ...
            <div id="Log_in">
                ...
                <?php if (isset($login_error)): ?>
                    <script>swal({ title: '<?= $login_error ?>', icon: 'error', });</script>
                <?php endif; ?>
                ...
                <!-- Employee Login -->
                <?php if (isset($emp_login_error)): ?>
                    <script>swal({ title: '<?= $emp_login_error ?>', icon: 'error', });</script>
                <?php endif; ?>
            ...
            <?php if (isset($signup_error)): ?>
                <script>swal({ title: '<?= $signup_error ?>', icon: 'error', });</script>
            <?php endif; ?>
            <div id="sign_up">
                <h2>Sign Up</h2>
